    ...
    <section id="location" className="relative px-4 py-24 sm:px-6 sm:py-32">
      <div className="mx-auto max-w-6xl">
        ...
        >
          ...
          <p className="mx-auto mt-4 max-w-md text-base text-cream/70">
            Visit Lake View Cafe in Madhura Nagar, Shamshabad, Hyderabad.
          </p>
        </motion.div>
        ...
        <div className="mt-12 grid gap-6 lg:grid-cols-2">
          ...
          >
            <iframe
              ...
              title={`Map showing ${cafe.name} location in Shamshabad, Hyderabad`}
